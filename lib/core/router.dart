...
import 'package:apartum/features/homepage/presentation/informasi_tanda_bahaya_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/informasi-tanda-bahaya': (_) => const InformasiTandaBahayaScreen(),
        ...
        '/riwayat-catatan': (context) {
          ...
          final tabIndex = args is Map<String, dynamic> ? args['tabIndex'] as int? ?? 0 : 0;
          return RiwayatCatatanScreen(initialTabIndex: tabIndex);
        },
      },
    );
  }
